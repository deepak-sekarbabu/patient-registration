...
public class PatientController {
  ...
  @Operation(summary = "Get patient by phone number",
      ...
      parameters = {@io.swagger.v3.oas.annotations.Parameter(name = "phoneNumber",
          description = "Phone number of the patient", required = true, example = "+919789801844")},
      responses = {
  ...
  @Operation(summary = "Check if user exists by phone number",
      description = "Returns true if a patient exists with the given phone number, false otherwise.",
      parameters = {@io.swagger.v3.oas.annotations.Parameter(name = "phoneNumber",
          description = "Phone number to check existence", required = true,
          example = "9876543210")},
      responses = {@ApiResponse(responseCode = "200", description = "Existence result",
  ...
  @Operation(summary = "Get patient by id",
      ...
      parameters = {@io.swagger.v3.oas.annotations.Parameter(name = "id",
          description = "ID of the patient", required = true, example = "1")},
      responses = {
          @ApiResponse(responseCode = "200", description = "Patient found",
              content = @Content(schema = @Schema(implementation = Patient.class))),
          @ApiResponse(responseCode = "404", description = "Patient not found",
  ...
  @Operation(summary = "Update patient information",
      ...
      requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(required = true,
          ...
          content = @Content(schema = @Schema(implementation = Patient.class))),
      parameters = {@io.swagger.v3.oas.annotations.Parameter(name = "id",
          description = "ID of the patient to update", required = true, example = "1")},
      responses = {
  ...
  public ResponseEntity<Patient> updatePatient(@PathVariable Long id,
      @io.swagger.v3.oas.annotations.parameters.RequestBody(
          description = "Patient object with fields to update") @org.springframework.web.bind.annotation.RequestBody @Valid Patient patient) {
  ...
  @Operation(summary = "Delete patient by id",
      ...
      parameters = {@io.swagger.v3.oas.annotations.Parameter(name = "id",
          description = "ID of the patient to delete", required = true, example = "1")},
      responses = {

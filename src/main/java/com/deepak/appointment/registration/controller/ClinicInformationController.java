...
public class ClinicInformationController {
  ...
  @Hidden
  @Operation(summary = "Get all clinics", description = "Retrieves information about all registered clinics", responses = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved clinic list", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClinicInformation.class)))
  })
  ...
  @Hidden
  @Operation(summary = "Get clinic by ID", description = "Retrieves information about a specific clinic by its ID", responses = {
  ...
  @Operation(summary = "Get basic clinic information", description = "Retrieves only clinic IDs and names", responses = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved basic clinic information", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ClinicInfoDropDown.class)))
  })
  ...
  @Operation(summary = "Get doctors for clinic", description = "Retrieves doctor IDs and names for a specific clinic ID, intended for dropdowns", responses = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved doctor list for clinic", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DoctorInfoDropDown.class)))
  })
  ...
  @Operation(summary = "Get available dates for booking", description = "Retrieves a list of dates with available slots for a specific clinic and doctor", responses = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved available dates", content = @Content(mediaType = "application/json"))
  })
  ...
  @Operation(summary = "Get available time slots", description = "Retrieves available time slots for a specific clinic, doctor, and date", responses = {
      @ApiResponse(responseCode = "200", description = "Successfully retrieved available slots", content = @Content(mediaType = "application/json"))
  })
  public ResponseEntity<Map<String, Object>> getAvailableSlots(
    ...
    Map<String, List<Map<String, String>>> slots = slotInformationService.getAvailableSlots(clinicId, doctorId, date);
